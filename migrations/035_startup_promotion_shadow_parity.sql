...
CREATE TABLE IF NOT EXISTS promotion_startup_shadow_state (
    ...
    compatibility_windows_observed BIGINT NOT NULL DEFAULT 0,
    compatibility_rotations_completed BIGINT NOT NULL DEFAULT 0,
    last_compatibility_wrapped      BOOLEAN NOT NULL DEFAULT FALSE,
