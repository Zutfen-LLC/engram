...
class AssessmentContract(StrictModel):
    ...
    # engram.assess.2 — #214 provider prompt/behavior correction (supersedes
    # engram.assess.1; see engram/assessment_provider.py).
    prompt_version: Literal["engram.assess.1", "engram.assess.2"] = "engram.assess.2"
