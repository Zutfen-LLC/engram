...
EXPECTED_MATRIX: dict[tuple[str, str], dict] = {
    ...
    ("POST", "/v1/items/{item_id}/reassess"): {"all_of": ("review",)},
    ("POST", "/v1/items/{item_id}/reassessments/{request_id}/retry"): {"all_of": ("review",)},
    ("POST", "/v1/assessments/reassess"): {"all_of": ("review",)},
    ...
    ("POST", "/v1/memory-profiles"): {"all_of": ("admin",)},
    ("GET", "/v1/memory-profiles"): {"all_of": ("admin",)},
    ("GET", "/v1/memory-profiles/{profile_id}"): {"all_of": ("admin",)},
    ("GET", "/v1/memory-profiles/{profile_id}/revisions"): {"all_of": ("admin",)},
    ("POST", "/v1/memory-profiles/{profile_id}/revisions"): {"all_of": ("admin",)},
    ("POST", "/v1/memory-profiles/{profile_id}/disable"): {"all_of": ("admin",)},
    ("POST", "/v1/memory-profiles/{profile_id}/enable"): {"all_of": ("admin",)},
